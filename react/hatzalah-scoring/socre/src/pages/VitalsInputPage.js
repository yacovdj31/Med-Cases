...
//     const [initialHealthLevel, setInitialHealthLevel] = useState('');
//     const [maxHealthLevel, setMaxHealthLevel] = useState('');
//     const [initialVitals, setInitialVitals] = useState(initialVitalState);
//     const [perfectVitals, setPerfectVitals] = useState(initialVitalState);
//     const [worseVitals, setWorseVitals] = useState(initialVitalState);
